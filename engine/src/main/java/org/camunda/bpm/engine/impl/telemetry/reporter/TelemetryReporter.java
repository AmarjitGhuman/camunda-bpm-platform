...
public class TelemetryReporter {
   ...
   */
  protected static long DEFAULT_INIT_REPORT_DELAY_SECONDS = 5 * 60;
  /**
   ...
   */
  protected static long EXTENDED_INIT_REPORT_DELAY_SECONDS = 3 * 60 * 60;
  ...
  protected long getInitialReportingDelaySeconds() {
